...
constexpr auto qt_meta_stringdata_CLASSqueryENDCLASS = QtMocHelpers::stringData(
    "query",
    "on_QueryButton_clicked",
    "",
    "on_SaveButton_clicked",
    "on_comboBox_1_activated",
    "index",
...
Q_CONSTINIT const QMetaObject query::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSqueryENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_comboBox_1_activated'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void query::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_comboBox_1_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
